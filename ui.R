...
navbarPage(
    ...
    tabPanel(
        ...
        div(h5("El viernes 18 el Congreso votará la vacancia del presidente Martín Vizcarra. 
            Creemos que si bien los hechos ameritan una investigación y posible sanción estos no justifican la vacancia del presidente especialmente en plena pandemia. 
            ...
            Más información y nuesta metodología", a(href = "https://docs.google.com/document/d/1wgdEtIyFvAcddj84fUqu8yXNsZ63VYaOZb9WEDRVjBM/edit?usp=sharing", "aquí."))
        ),
        div(
        tags$ol(
            ...
            tags$li("Preparamos un correo por tí, necesitamos tu DNI y Nombre (no lo guardamos ver último punto)"),
            tags$li("Copia el texto y envíalo desde tu correo. Pronto(boton para conectarse con tu email, más fácil imposible)"),
            tags$li("La última pregunta es para saber si quieres ser parte de la carta grupal que mandaremos el día jueves. (solo en este caso guardamos tus datos)")
        )),
        sidebarLayout(
        sidebarPanel(
