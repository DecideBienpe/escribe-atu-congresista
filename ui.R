...
navbarPage(
  ...
  tabPanel(
    ...
    div(h5("El viernes 18 el Congreso votará la vacancia del presidente Martín Vizcarra. 
            Creemos que si bien los hechos meritan una investigación y posible sanción estos no justifican la vacancia del presidente especialmente en plena pandemia. 
